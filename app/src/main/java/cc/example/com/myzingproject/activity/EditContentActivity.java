...
/**
 * 编辑短信页面
 * Created by cheney on 2015/8/17.
 */
public class EditContentActivity extends Activity {
    ...
    private void initView() {
        ...
        back_arrow=(ImageView)findViewById(R.id.id_back_arrow);
    ...
    public void initVariables() {
        ...
        data = new ArrayList<>();
        mAdapter = new CommonAdapter<String>(EditContentActivity.this,data,R.layout.item_content) {
            @Override
        ...
        sureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(meditmessage.getText().toString()) && meditmessage.getText().toString() != null) {
                    ...
                    Toast.makeText(EditContentActivity.this,"请输入短信内容",Toast.LENGTH_SHORT).show();
                }
            }
        });

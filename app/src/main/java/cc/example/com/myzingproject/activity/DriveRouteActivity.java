...
import cc.example.com.myzingproject.utils.AMapUtil;
import cc.example.com.myzingproject.utils.DrivingRouteOverlay;
...
public class DriveRouteActivity extends Activity implements OnMapClickListener,
	...
	private LatLonPoint mStartPoint = new LatLonPoint(31.302800,120.649660);//起点，31.3028000000,120.6496600000
	private LatLonPoint mEndPoint = new LatLonPoint(31.328800,120.610960);//终点，31.3288000000,120.6109600000
	...
	public void searchRouteResult(int routeType, int mode) {
		if (mStartPoint == null) {
			Toast.makeText(mContext, "定位中，稍后再试...",Toast.LENGTH_LONG).show();
			return;
		}
		if (mEndPoint == null) {
